...
<div class="field">
    <label class="label" for="pasword">Password</lable>
...
<div class="field">
    <label class="checkbox" for="is_active"> 
        <?php if ($user->id == current_user()->id): ?>
            <input type="checkbox" checked disable> active
...
<div>
    <label class="checkbox" for="is_admin"> 
        <?php if ($user->id == current_user()->id): ?>
            <input class="checkbox" type="checkbox" checked disable> administrator
