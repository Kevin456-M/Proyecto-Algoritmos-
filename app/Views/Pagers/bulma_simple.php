...
<nav class="pagination">
	<ul class="pager pagination-list">
		<li <?= $pager->hasPrevious() ? '' : 'class="disabled"' ?>>
			<a class="pager pagination-previous" href="<?= $pager->getPrevious() ?? '#' ?>" aria-label="<?= lang('Pager.previous') ?>">
				<span aria-hidden="true"><?= lang('Pager.newer') ?></span>
			</a>
		</li>
		<li <?= $pager->hasNext() ? '' : 'class="disabled"' ?>>
			<a class="pager pagination-previous" href="<?= $pager->getNext() ?? '#' ?>" aria-label="<?= lang('Pager.next') ?>">
